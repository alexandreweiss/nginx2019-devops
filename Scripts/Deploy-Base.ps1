...
$rgEnvName = $friendlyLocation + '-' + $environment + '-' + $appCode + '-base'
...
$templateFile = $PSScriptRoot + '\..\Templates\Base\Template-Base.json'
$paramFile = $PSScriptRoot + '\..\Templates\Base\Param-Base.json'
